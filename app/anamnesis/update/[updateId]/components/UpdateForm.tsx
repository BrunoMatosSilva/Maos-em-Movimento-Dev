...
export const UpdateForm = () => {
  const {
    ...
    defaultValues: {
      ...
      coluna: "Sim",
      fisica: "Sim",
      doença_fisica: "Academia de semana e caminhada aos sábados.",
      outra_doença_fisica: null,
      cirurgia: "Sim",
      doença_cirurgia: "Retirei a vísicula.",
      medicamento: "Não",
      doença_medicamento: null,
      queixa: "Dor na coluna apos dia de trabalho.",
      frase: "Bom dia!",
      projeto: "Instagram."
    }
  })
